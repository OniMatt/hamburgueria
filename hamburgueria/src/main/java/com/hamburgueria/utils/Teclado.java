package com.hamburgueria.utils;
...
public class Teclado {
  ...
  public static boolean leBoolean(String msg) {
    ...
    try {
      s = d.readLine();
      if (s.toUpperCase().equals("SIM") || s.toUpperCase().equals("S"))
        a = true;
      else if (s.toUpperCase().equals("NAO") || s.toUpperCase().equals("NÃO") || s.toUpperCase().equals("N"))
        a = false;
    } catch (IOException e) {
      System.out.println("Erro de I/O: " + e);
    } catch (NumberFormatException e) {
      System.out.println("o valor digitado deve ser uma String: " + e);
    }
    return (a);
  }
